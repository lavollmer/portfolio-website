...
const Skills = () => {
  return (
    <section
      className="text-black-600 items-center text-center md:m-20"
      id="skills"
    >
      <div className="grid-cols-3 gap-4 mx-auto">
        <div className="flex flex-wrap w-half mb-5 flex-col items-center text-center">
        ...
        <div className="flex flex-wrap -m-2">
          <div className="xl:w-1/3 md:w-1/2 p-4">
            <div className="border border-black p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                ...
                mainly for enhancing user interaction with webpages, and making
                the web more dynamic and responsive.
              </p>
            </div>
          </div>
          <div className="xl:w-1/3 md:w-1/2 p-4">
          ...
          <div className="xl:w-1/3 md:w-1/2 p-4">
            <div className="border border-black p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                Cascading Style Sheets is the language used to style web pages,
                controlling the design, layout, and display variations for
          ...
          <div className="xl:w-1/3 md:w-1/2 p-4">
            <div className="border border-black p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                ...
                creating web pages and web applications, defining the structure
          ...
          <div className="xl:w-1/3 md:w-1/2 p-4">
            <div className="border border-black p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                Programming project management involves using Trello and Google
                Spreadsheets to organize tasks, and collaborate with the
                development team.
              </p>
            </div>
          </div>
