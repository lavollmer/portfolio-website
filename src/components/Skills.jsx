      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div
            ...
            id="skills"
          >
            <h1 className="text-6xl font-poppins mr-8">Technical Skills</h1>
            ...
            <p className="sm:text-m md:text-lg p-2 w-full leading-relaxed text-black font-poppins">
          ...
          <div className="flex flex-wrap -m-2">
            <div className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-black p-6 rounded-lg">
                <div className="w-10 h-10 inline-flex items-center justify-center rounded-full bg-blue text-white mb-4">
                  <IoLogoJavascript />
                </div>
