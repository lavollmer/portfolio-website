      ...
      <div className="container mx-auto w-full h-full flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <div className="flex lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0 space-x-5">
          <a href="https://www.linkedin.com/in/lvollmer/">
            <button className="inline-flex items-center bg-[#838871] text-white border-0 py-1 px-3 focus:outline-none hover:bg-[#BABf7B2] rounded text-base mt-4 md:mt-0">
              LinkedIn
              <svg
                fill="none"
                stroke="currentColor"
          ...
          <a href="https://github.com/lavollmer">
            <button className="inline-flex items-center bg-[#838871] text-white border-0 py-1 px-3 focus:outline-none hover:bg-[#BAB7B2] rounded text-base mt-4 md:mt-0">
              Github
              <svg
                fill="none"
                stroke="currentColor"
