    ...
    <header class="text-gray-600 body-font">
      <div class="container mx-auto w-full h-full flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <a class="flex order-first lg:order-none lg:w-1/5 title-font font-medium items-center text-gray-900 lg:items-center lg:justify-center mb-4 md:mb-0">
          <span class="ml-3 text-2xl border-solid font-family-arial">
            Laura Vollmer
          </span>
        </a>
        <div class="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
          <a href="https://www.linkedin.com/in/lvollmer/">
            <button class="inline-flex items-center bg-[#838871] text-white border-0 py-1 px-3 focus:outline-none hover:bg-[#BAB7B2] rounded text-base mt-4 md:mt-0">
              LinkedIn
              <svg
                fill="none"
                stroke="currentColor"
